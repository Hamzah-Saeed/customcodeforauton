## VERY ROUGH, sampled after code i found online, likely requires refinement to work correctly
...
class GpsWaypointCommander(Node):
    """
    ROS2 node to send GPS waypoints to nav2 using manual coordinate input
    """
    def __init__(self):
